...
const MODULES = [
  {
    id: 'messaging',
    label: 'Messaging',
    description: 'Connect channels, automate conversations and capture structured data.',
...
const QUICK_ACTIONS = [
  {label: 'Open Messaging module', sub: 'Inbox & channels',     href: '/modules/messaging', icon: MessageSquare},
  {label: 'Create an agent',       sub: 'Custom AI behaviors',  href: '/agents',            icon: Bot},
  {label: 'View activity log',     sub: 'Real-time events',     href: '/activity',          icon: TrendingUp},
] as const;
      ...
      <section className="relative overflow-hidden rounded-3xl border border-zinc-200/80 bg-white shadow-soft dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="relative flex flex-col items-start justify-between gap-6 p-8 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-2">
            <Link href="/modules" className="btn-secondary h-10 px-4">
              <Layers size={14} />
              Modules
            </Link>
