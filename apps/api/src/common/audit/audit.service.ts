...
export const AuditAction = {
  ...
  PLATFORM_USER_CREATED: 'platform.users.created',
  PLATFORM_USER_UPDATED: 'platform.users.updated',
  ...
  PLATFORM_MODULE_GOVERNANCE_UPDATED: 'platform.modules.governance.updated',
  PLATFORM_POLICY_UPDATED: 'platform.policies.updated',
