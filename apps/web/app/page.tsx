...
const MODULES = [
  {
    ...
    description: 'Connect WhatsApp, Telegram, Instagram and more. Unified inbox with smart routing and shared context.',
  ...
  },
  {
    ...
    features: ['Custom system prompts', 'Tool & function calling', 'Knowledge base'],
    href: '#',
    badge: 'Available',
  ...
  },
  {
    ...
    description: 'Build workflows that execute across modules. Triggers, conditions, and human-in-the-loop approval.',
  ...
  },
  {
    ...
    description: 'Track conversation outcomes, agent performance, and conversion. Export to your warehouse.',
    features: ['Real-time metrics', 'Conversion funnels', 'Snowflake / BQ export'],
    href: '#',
    badge: 'Coming soon',
...
const FEATURES = [
  {
    ...
    description: 'Pre-built agents for scheduling, qualification, and triage — production-ready in minutes, not months.',
  },
  {
    icon: GitBranch,
    title: 'Multi-channel routing',
    description: 'Route every message through the right agent based on intent, channel, customer profile, or business hours.',
  },
  {
    icon: Database,
    title: 'Structured extraction',
    description: 'Capture appointments, leads, and orders as typed records — directly to your CRM or database.',
  },
  {
    icon: Shield,
    title: 'Guardrails & compliance',
    description: 'Per-agent guardrails, PII redaction, audit logs, and full conversation history for review.',
  },
  {
    icon: Globe,
    title: 'Multi-tenant from day one',
    description: 'Workspaces, role-based access, and tenant-isolated data. Built for agencies and platforms.',
  },
  {
    icon: Mic,
    title: 'Voice & text, one stack',
    description: 'Same agent, same context — across WhatsApp text, Instagram DMs, and inbound voice calls.',
  },
] as const;
...
const USE_CASES = [
  ...
  },
  {
    ...
    description: 'Your reps wake up to qualified leads, not a backlog of cold messages. Every lead enriched, scored, and routed.',
    bullets: ['Inbound qualification', 'CRM sync', 'Smart routing by territory'],
  },
  {
    icon: Workflow,
    sector: 'Support & Operations',
    headline: 'Tier-1 resolved by AI, escalations routed to humans',
    description: 'Agents resolve common requests, capture structured data, and hand off to humans with full context when needed.',
...
const PLANS = [
  ...
  },
  {
    ...
    description: 'For growing teams with multiple channels and active automations.',
    features: [
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_1fr]">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="mt-6 h-display text-zinc-900 dark:text-zinc-50">
                AI agents for{' '}
                <span className="text-gradient">every conversation</span> your business has.
              </h1>
      ...
      {/* ════════════════════════════════════════════════════
          MODULES
      ═══════════════════════════════════════════════════ */}
      <section id="modules" className="relative py-24 sm:py-28">
        <div className="container-page">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 h-display-sm text-zinc-900 dark:text-zinc-50">
              One platform.<br />
              <span className="text-gradient-subtle">Composable modules.</span>
            </h2>
            <p className="mt-5 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
              Activate the modules you need. Each is purpose-built, deeply integrated,
              and ships with sensible defaults out of the box.
            </p>
          </div>

          <div className="mt-14 grid gap-5 md:grid-cols-2">
            {MODULES.map(({icon: Icon, title, eyebrow, description, features, badge, accent, iconBg}) => (
              <div
                key={title}
                className="group relative overflow-hidden rounded-2xl border border-zinc-200/80 bg-white p-7 transition-all hover:-translate-y-0.5 hover:shadow-card dark:border-zinc-800 dark:bg-zinc-900"
              >
                {/* Soft tinted gradient overlay */}
                <div className={`pointer-events-none absolute -inset-x-12 -top-12 h-48 bg-gradient-to-br opacity-0 transition-opacity duration-500 group-hover:opacity-100 ${accent}`} />
                ...
                <div className="relative">
                  <div className="flex items-start justify-between">
                    ...
                    <span className={
                      'pill text-[10px] font-semibold uppercase tracking-widest ' +
                      (badge === 'Available'
                        ? 'border-emerald-200/80 bg-emerald-50/80 text-emerald-700 dark:border-emerald-800/80 dark:bg-emerald-900/20 dark:text-emerald-400'
                        : badge === 'Beta'
                        ? 'border-amber-200/80 bg-amber-50/80 text-amber-700 dark:border-amber-800/80 dark:bg-amber-900/20 dark:text-amber-400'
                        : 'border-zinc-200/80 bg-zinc-50/80 text-zinc-500 dark:border-zinc-700 dark:bg-zinc-800/60 dark:text-zinc-500')
                    }>
                      {badge}
                    </span>
                  </div>

                  <p className="mt-6 text-[11px] font-semibold uppercase tracking-widest text-brand-600 dark:text-brand-400">
                    {eyebrow}
                  </p>
                  <h3 className="mt-1.5 text-xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">
                    {title}
                  </h3>
                  ...
                  <ul className="mt-5 space-y-2">
                    {features.map((f) => (
                      <li key={f} className="flex items-center gap-2 text-sm text-zinc-700 dark:text-zinc-300">
                        <Check size={14} className="text-brand-500 dark:text-brand-400" />
                        {f}
                      </li>
                    ))}
                  </ul>
      ...
      {/* ════════════════════════════════════════════════════
          FEATURES GRID
      ═══════════════════════════════════════════════════ */}
      <section id="features" className="relative border-y border-zinc-200/80 bg-zinc-50/60 py-24 dark:border-zinc-800/80 dark:bg-zinc-900/40">
        <div className="container-page">
          <div className="mx-auto max-w-2xl text-center">
            <p className="section-eyebrow">Why Synapse</p>
            <h2 className="mt-3 h-display-sm">
              Built for production,<br />from the first message.
            </h2>
            <p className="mt-5 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
              Most AI tools stop at the demo. Synapse ships the boring-but-essential infrastructure
              you need to run agents at scale.
            </p>
          </div>
      ...
      <section className="py-24 sm:py-28">
        <div className="container-page">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 h-display-sm">
              From clinics to commerce.<br />
              <span className="text-gradient-subtle">All in one stack.</span>
            </h2>
          </div>

          <div className="mt-14 space-y-5">
            {USE_CASES.map(({icon: Icon, sector, headline, description, bullets}, idx) => (
              <div
                key={sector}
                className={
                  ...
                  (idx % 2 === 1 ? 'lg:bg-zinc-50/60 dark:lg:bg-zinc-900/60' : '')
                }
              >
                {/* Big number / icon */}
        ...
        <div className="container-page">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <blockquote className="mt-6 text-balance text-2xl font-medium leading-snug tracking-tight text-zinc-100 sm:text-3xl">
              &ldquo;We replaced two SaaS tools and 600 lines of glue code with a single Synapse workspace.
              Our agents now respond in under a second, with zero infrastructure for our team to maintain.&rdquo;
            </blockquote>
            <div className="mt-8 flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-zinc-400">Head of Operations · Northstar Clinic</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="relative py-24 sm:py-28">
        <div className="container-page">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-5 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
              Start free. Upgrade when you outgrow it. Talk to us for high-volume needs.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-700 via-brand-600 to-accent-600 px-8 py-16 sm:px-16 sm:py-20">
            ...
            <div className="relative mx-auto max-w-3xl text-center text-white">
              ...
              <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-white/85 sm:text-lg">
                Spin up your first agent in minutes. Free for the first 1,000 messages.
              </p>
      ...
      <footer className="border-t border-zinc-200/80 bg-white py-16 dark:border-zinc-800/80 dark:bg-zinc-950">
        <div className="container-page">
          <div className="grid gap-10 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr]">
            ...
            <div>
              <Link href="/" className="flex items-center gap-2.5">
                <Image src="/logo.png" alt="Synapse" width={32} height={32} className="rounded-lg ring-1 ring-black/5 dark:ring-white/10" />
              ...
              <p className="mt-4 max-w-xs text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                AI agent orchestration for modern businesses. Built for teams who ship.
              </p>
            </div>

            {/* Product */}
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">Product</p>
              <ul className="mt-4 space-y-2.5 text-sm">
                <li><a href="#modules"  className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Modules</a></li>
                <li><a href="#features" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Features</a></li>
                <li><a href="#pricing"  className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Pricing</a></li>
                <li><a href="#"         className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Changelog</a></li>
              </ul>
            </div>

            <div>
              <p className="text-[11px] font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">Resources</p>
              <ul className="mt-4 space-y-2.5 text-sm">
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Documentation</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">API reference</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Guides</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Status</a></li>
              </ul>
            </div>

            <div>
              <p className="text-[11px] font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">Company</p>
              <ul className="mt-4 space-y-2.5 text-sm">
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">About</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Customers</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Careers</a></li>
                <li><a href="mailto:hello@synapse.ai" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Contact</a></li>
              </ul>
            </div>

            <div>
              <p className="text-[11px] font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">Legal</p>
              <ul className="mt-4 space-y-2.5 text-sm">
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Privacy</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Terms</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">Security</a></li>
                <li><a href="#" className="text-zinc-700 hover:text-brand-600 dark:text-zinc-300 dark:hover:text-brand-400">DPA</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center justify-between gap-3 border-t border-zinc-200 pt-8 text-xs text-zinc-500 sm:flex-row dark:border-zinc-800 dark:text-zinc-500">
            <p>© {new Date().getFullYear()} Synapse Labs. All rights reserved.</p>
